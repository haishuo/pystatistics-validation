"""Comparison helpers for montecarlo validation records.

Small, dependency-free helpers to turn a pystatistics-vs-R comparison into a
serializable record with max absolute / relative differences, NaN-aware. One
definition of "agree" shared by every runner.
"""
